export function initLocalStorageManager() {
  ...
  if (path.includes("cadastro_usuario.php")) {
    ...
    const btnLimpar = document.querySelector(
      "button[type='reset'], .btn-limpar"
    );

    if (localStorage.getItem("cad_nome") && campoNome)
      campoNome.value = localStorage.getItem("cad_nome");
    if (localStorage.getItem("cad_loja") && campoLoja)
      campoLoja.value = localStorage.getItem("cad_loja");
    if (localStorage.getItem("cad_email") && campoEmail)
      campoEmail.value = localStorage.getItem("cad_email");

    if (campoNome)
      campoNome.addEventListener("input", () =>
        localStorage.setItem("cad_nome", campoNome.value)
      );
    if (campoLoja)
      campoLoja.addEventListener("input", () =>
        localStorage.setItem("cad_loja", campoLoja.value)
      );
    if (campoEmail)
      campoEmail.addEventListener("input", () =>
        localStorage.setItem("cad_email", campoEmail.value)
      );
  ...
  if (path.includes("duplicar_pedidos.php")) {
    ...
    if (localStorage.getItem("dup_prazo") && campoData)
      campoData.value = localStorage.getItem("dup_prazo");
    if (localStorage.getItem("dup_status") && campoStatus)
      campoStatus.value = localStorage.getItem("dup_status");
    if (localStorage.getItem("dup_comentario") && campoComentario)
      campoComentario.value = localStorage.getItem("dup_comentario");

    if (campoData)
      campoData.addEventListener("input", () =>
        localStorage.setItem("dup_prazo", campoData.value)
      );
    if (campoStatus)
      campoStatus.addEventListener("change", () =>
        localStorage.setItem("dup_status", campoStatus.value)
      );
    if (campoComentario)
      campoComentario.addEventListener("input", () =>
        localStorage.setItem("dup_comentario", campoComentario.value)
      );
  ...
  if (path.includes("alteracao_pedidos.php")) {
    ...
    if (localStorage.getItem("alt_prazo") && campoData)
      campoData.value = localStorage.getItem("alt_prazo");
    if (localStorage.getItem("alt_status") && campoStatus)
      campoStatus.value = localStorage.getItem("alt_status");
    if (localStorage.getItem("alt_comentario") && campoComentario)
      campoComentario.value = localStorage.getItem("alt_comentario");

    if (campoData)
      campoData.addEventListener("input", () =>
        localStorage.setItem("alt_prazo", campoData.value)
      );
    if (campoStatus)
      campoStatus.addEventListener("change", () =>
        localStorage.setItem("alt_status", campoStatus.value)
      );
    if (campoComentario)
      campoComentario.addEventListener("input", () =>
        localStorage.setItem("alt_comentario", campoComentario.value)
      );
  ...
  if (path.includes("cadastro_pedidos.php")) {
    ...
    if (localStorage.getItem("cad_pedido_prazo") && campoData)
      campoData.value = localStorage.getItem("cad_pedido_prazo");
    if (localStorage.getItem("cad_pedido_status") && campoStatus)
      campoStatus.value = localStorage.getItem("cad_pedido_status");
    if (localStorage.getItem("cad_pedido_comentario") && campoComentario)
      campoComentario.value = localStorage.getItem("cad_pedido_comentario");

    if (campoData)
      campoData.addEventListener("input", () =>
        localStorage.setItem("cad_pedido_prazo", campoData.value)
      );
    if (campoStatus)
      campoStatus.addEventListener("change", () =>
        localStorage.setItem("cad_pedido_status", campoStatus.value)
      );
    if (campoComentario)
      campoComentario.addEventListener("input", () =>
        localStorage.setItem("cad_pedido_comentario", campoComentario.value)
      );
  ...
  if (path.includes("view_loja.php")) {
    ...
    const campoTelefone = document.querySelector(
      "input[name='telefoneCliente']"
    );
    const campoMensagem = document.getElementById("mensagemCliente");
    const formSolicitacao = document.querySelector(
      "form[action*='pedidoControle.php']"
    );
    const btnLimparCarrinho = document.querySelector("a.btn-limpar"); // Seleciona o link de limpar

    if (localStorage.getItem(chaveLoja + "_nome") && campoNome)
      campoNome.value = localStorage.getItem(chaveLoja + "_nome");
    if (localStorage.getItem(chaveLoja + "_telefone") && campoTelefone)
      campoTelefone.value = localStorage.getItem(chaveLoja + "_telefone");
    if (localStorage.getItem(chaveLoja + "_mensagem") && campoMensagem)
      campoMensagem.value = localStorage.getItem(chaveLoja + "_mensagem");

    if (campoNome)
      campoNome.addEventListener("input", () =>
        localStorage.setItem(chaveLoja + "_nome", campoNome.value)
      );
    if (campoTelefone)
      campoTelefone.addEventListener("input", () =>
        localStorage.setItem(chaveLoja + "_telefone", campoTelefone.value)
      );
    if (campoMensagem)
      campoMensagem.addEventListener("input", () =>
        localStorage.setItem(chaveLoja + "_mensagem", campoMensagem.value)
      );
    ...
    // Intercepta o envio do formulário para limpar o storage antes da página recarregar pelo GET
    if (formSolicitacao) {
    ...
    // Limpa também se o usuário clicar no link de limpar carrinho
  ...
  if (path.includes("alterar_usuario.php") || path.includes("minha_area.php")) {
    ...
    const campoLoja = document.querySelector("input[name='usuLoja']");
    const campoEmail = document.querySelector("input[name='usuEmail']");
    const checkView = document.querySelector(
      "input[name='aceitaVisualizacao']"
    );
    ...
    if (campoNomeView)
      campoNomeView.addEventListener("input", () =>
