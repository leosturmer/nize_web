...
<body>
    ...
    <main>
        ...
        <details>
            <summary style="cursor: pointer;">Clique para adicionar mais produtos ao pedido clonado</summary> 
                        ...
                        <?php if (!empty($listaProdutos)): ?>
                            <?php foreach ($listaProdutos as $item):?>
                                <div class="product-view">
                                    ...
                                    <p><strong>Descrição:</strong> <?php echo htmlspecialchars($item['descricao']) ? htmlspecialchars($item['descricao']) : 'Sem informações';?></p>
        ...
        <div class="produtos-no-pedido">
            <h3>Produtos inseridos no clone</h3>
            <?php
            ...
            echo "<p><b>Total do pedido clonado</b>: R$ " . number_format($_SESSION['total_compra'], 2, ',', '.') . "</p>";
            ?>
        </div>
        ...
        <form action="../controller/pedidoControle.php" method="get">
            ...
            <button type="submit">Salvar Novo Pedido Clonado</button>
            <a href="../controller/pedidoControle.php?op=limparCarrinho" style="margin-left: 15px;">Cancelar Clonagem</a>
        </form>
    ...
    <script>
        ...
        if (msgElement) {
            setTimeout(() => { msgElement.style.display = 'none'; }, 6000);
        }
    </script>
</body>
</html>