    ...
    <main class='conteudo-pagina'>
        ...
        <div class="internal-nav">
            <div class="internal-nav-links">
                ...
                <a href="<?php echo BASE_URL; ?>visualizacao_pedidos"><span class="bi bi-arrow-left"></span>Voltar</a>
            </div>
        </div>
            ...
            <div class="infos-pedido">
                <div class='total-pedido'>
                    ...
                    <div class="form-pedidos-items form-pedidos-buttons">
                        ...
                        <a href="<?php echo BASE_URL; ?>php/controller/pedidoControle.php?op=limparCarrinho" class="btn-limpar"><span class="bi bi-arrow-clockwise"></span>Limpar</a>
                    </div>
                </form>
            </div>
        </div>
