...
<head>
    ...
    <title>Duplicar Pedido - Nize</title>
</head>
                ...
                if (!empty($_SESSION['carrinho'])) {
                    foreach ($_SESSION['carrinho'] as $id_produto => $quantidade) {
                        ...
                        if ($produtoVendido) {
                            ...
                            echo "<a href='../../controller/pedidoControle.php?op=removerQuantidade&id=$id_produto&valor=$valor&origem=duplicar' class='btn-remover'><span class='bi bi-x'></span>Remover</a>";
                            echo "</div>";
                        } else {
                    ...
                    <div class="form-pedidos-items">
                        <fieldset id="pedidos-form">
                            ...
                            <label for="comentarioPedido" class="label-column">
                                ...
                                <textarea maxlength="500" rows="5" cols="40" name="comentarioPedido" id="comentarioPedido" class="input-pedido" placeholder="Detalhes do novo pedido..."></textarea>
                            </label>
                        </fieldset>
                    </div>
                    <div class="form-pedidos-items">
