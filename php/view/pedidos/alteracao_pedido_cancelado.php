          ...
          foreach ($_SESSION['carrinho'] as $id_produto => $item) {
            ...
            if ($produtoVendido) {
              ...
              if (basename($_SERVER['PHP_SELF']) == 'alteracao_pedidos.php') {
                echo "<a href='" . BASE_URL . "php/controller/pedidoControle.php?op=removerQuantidade&id=$id_produto&id_pedido=$id_pedido' class='btn-remover'><span class='bi bi-x'></span>Remover</a>";
              }
