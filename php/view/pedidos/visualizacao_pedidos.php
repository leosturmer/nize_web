...
<head>
  ...
  <title>Lista de Pedidos- Nize</title>
</head>
...
<body>
  ...
  <main class='conteudo-pagina'>
    ...
    <div class="internal-nav">
      <div class="internal-nav-links">
        ...
        <a href="/nize_web/cadastro_pedidos"><span class="bi bi-plus-lg"></span>Pedido</a>
      </div>

      <div class="internal-nav-inputs">
        <form onsubmit="return false;" id="form-pesquisa-pedidos">
          <input type="text" id="pesquisa-pedidos" placeholder="Digite sua pesquisa" autocomplete="off" maxlength="50"><span id="search-icon" class="bi bi-search"></span>
        </form>
        ...
        <details class="filtros-produtos">
          ...
          <div>
            <input type="date" id="filtro-data" autocomplete="off" value="0000-00-00">
  ...
  <script src="/nize_web/js//busca_pedidos.js"></script>
