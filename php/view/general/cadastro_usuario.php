...
<body>
    ...
    <main id="main-index">
        ...
        <a href="/nize_web/" class="link-logo-header logo-header-mobile" title="Tela inicial">
        ...
        <div class="container container-cadastro">
            ...
            <div class="div-cadastro">
                <form action="/nize_web/php/controller/cadastroControle.php?op=cadastrar" method="post" id="form-cadastro">
        ...
        <a href="/nize_web/login" id="btn-login">Já tem cadastro?</a>
