    ...
    <main id="main-index">
        ...
        <div class="container container-cadastro">
            ...
            <div class="div-cadastro">
                <form action="<?php echo BASE_URL; ?>php/controller/cadastroControle.php?op=cadastrar" method="post" id="form-cadastro">
        ...
        <a href="<?php echo BASE_URL; ?>login" id="btn-login">Já tem cadastro?</a>
