...
switch ($opcao) {
    case "adicionarQuantidade":
        ...
        if ($origem === 'duplicar') {
            header("location:" . BASE_URL . "duplicar_pedido");
        } else if (isset($_SESSION['pedidoSelecionado'])) {
            header("location:" . BASE_URL . "alteracao_pedidos?id=" . $_SESSION['pedidoSelecionado']['id_pedido']);
        } else {
    ...
    case "adicionarSacola":
        ...
        header("Location:" . BASE_URL . urlencode($nome_visualizacao));
        exit;
    ...
    case "removerQuantidade":
        ...
        if ($origem === 'loja') {
            ...
            header("Location:" . BASE_URL . "view_loja?loja=" . urlencode($loja));
            exit;
        } else {
            ...
            if ($origem === 'duplicar') {
                header("location:" . BASE_URL . "view/pedidos/duplicar_pedido.php");
            } else if (isset($_SESSION['pedidoSelecionado'])) {
                header("location:" . BASE_URL . "view/pedidos/alteracao_pedidos.php?id=" . $_SESSION['pedidoSelecionado']['id_pedido']);
            } else {
                header("location:" . BASE_URL . "view/pedidos/cadastro_pedidos.php");
            }
            exit;
        }
    ...
    case "limparCarrinho":
        ...
        if ($origem === 'loja') {
            ...
            $_SESSION['sacola'] = [];
            header("Location:" . BASE_URL . "view/usuario/view_loja.php?loja=" . urlencode($loja));
        } else {
            ...
            if (isset($_SESSION['pedidoSelecionado'])) {
                ...
                header("location:" . BASE_URL . "view/pedidos/visualizacao_pedidos.php");
            } else {
                header("location:" . BASE_URL . "view/pedidos/cadastro_pedidos.php");
            }
        }
    ...
    case "carregarQuantidade":
        ...
        $duplicar = isset($_GET['duplicar']) && $_GET['duplicar'] == 'true';
        ...
        if (!empty($pedido)) {
            ...
            if ($pedido['status'] != "cancelado" && $pedido['status'] != 'vendido') {
                header("location:" . BASE_URL . "view/pedidos/alteracao_pedidos.php");
            } else if ($pedido['status'] == "cancelado") {
                header("location:" . BASE_URL . "view/pedidos/alteracao_pedido_cancelado.php");
            } else if ($pedido['status'] == "vendido") {
                header("location:" . BASE_URL . "view/pedidos/alteracao_pedido_vendido.php");
            }
        } else {
    ...
    case "solicitarPedido":
        try {
            ...
            if (!Validacao::validarTelefone($telefoneCliente) && $telefoneCliente !== '') {
            ...
            $buscaPedido = $pedidoDAO->buscarPedidoID($id_pedido_gerado);
            $numero_formatado = $buscaPedido['num_pedido'];
    ...
    case "alterar":
        try {
            ...
            $_SESSION['msg'] = "<p class='error-msg'>Algo deu errado! Tente novamente</p>";
            header("Location:" . BASE_URL . "view/pedidos/alteracao_pedidos.php?id=$id_pedido");
        }
        exit;
