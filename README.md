...
O projeto teve início em 2024, ganhando inicialmente [uma versão em Python]([url](https://github.com/leosturmer/Nize_Python_Desktop)). Atualmente, o projeto está em sua fase final, onde foi desenvolvido em PHP, utilizando banco de dados SQLite, e com a interface gráfica construída com CSS e JavaScript.
